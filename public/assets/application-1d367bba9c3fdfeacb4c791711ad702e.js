...
(function() {
  ...
  Campo = {
    ...
    telefonoValido: function(numero) {
      var expr;
      expr = /^([0-9])+$/;
      return expr.test(numero);
    }
  };

  jQuery(function() {
    $("#problem_title").blur(function() {
      if (Campo.campoValido(this.value)) {
        return $(".titleerror").css({
          visibility: 'hidden'
        });
      } else {
        return $(".titleerror").css({
    ...
    $("#problem_description").blur(function() {
      if (Campo.campoValido(this.value)) {
        return $(".descriperror").css({
          visibility: 'hidden'
        });
      } else {
        return $(".descriperror").css({
    ...
    $("#problem_telephone").blur(function() {
      if (Campo.telefonoValido(this.value)) {
        return $(".telerror").css({
          visibility: 'hidden'
        });
      } else {
    ...
    return $("#problem_contact").blur(function() {
      if (Campo.correoValido(this.value)) {
        return $("#emailerror").css({
          visibility: 'hidden'
        });
      } else {
        return $("#emailerror").css({
